(function () {
    ...
    app.component('workersall', {
        templateUrl: 'app/workersall/workersall.template.html?v=2',
        controller: WorkersallController,
        bindings: {
            workers: '<',
            departments: '<'
    ...
    function WorkersallController(usersService, sharedValues, $state, $http) {
        ...
        function _sendSMS(type) {
            ...
            if (type == 33) {
                ...
                if (workersSelected.length == 1) {
                    ...
                    usersService.sendSMS(workersSelected, true, ctrl.currentPage, ctrl.pageSize, ctrl.filterText, 44).then(function (res) {
