  ...
  /* function for adding stylesheet to body*/
   ...
   /* function for hiding toast Message*/
    let hideToast = function (selector) {
        ...
        $(selector).fadeOut(500, function () { selector.remove(); $('.confirmBG').remove(); });
		}
...
const successToast=function(options){
  ...
  align=(options.align? (options.align).toLowerCase():'topright' );
    ...
    htmlData = $('<div class="confirmBG"></div><div style="top:150px;" class="toastContainer toast' + align + '" onclick="webToast.ToastRemove(this)"><div  class="webToast toastSuccess"><div class="toastIcon"> &#10003; </div><div class="toastContent"><p class="toastStatus">' + options.status + '</p><p class="toastMessage">' + options.message +'</p></div><div class="toast__close"> &#10799; </div></div></div>');
...
const dangerToast=function(options){
  ...
  align=(options.align? (options.align).toLowerCase():'topright' );
    ...
    htmlData = $('<div class="confirmBG"></div><div style="top:150px;" class="toastContainer  toast' + align + '"  onclick="webToast.ToastRemove(this)"><div  class="webToast toastDanger"><div class="toastIcon"> &#9432; </div><div class="toastContent"><p class="toastStatus">' + options.status + '</p><p class="toastMessage">' + options.message +'</p></div><div class="toast__close"> &#10799; </div></div></div>');
...
const infoToast=function(options){
  ...
  align=(options.align? (options.align).toLowerCase():'topright' );
    ...
    htmlData = $('<div class="confirmBG"></div><div style="top:150px;" class="toastContainer  toast' + align + '" onclick="webToast.ToastRemove(this)"><div  class="webToast toastInfo"><div class="toastIcon"> &#9432; </div><div class="toastContent"><p class="toastStatus">' + options.status + '</p><p class="toastMessage">' + options.message +'</p></div><div class="toast__close"> &#10799; </div></div></div>');
...
const ConfirmToast=function(options){
  ...
  '<button data-confirm >&nbsp;&nbsp;λο&nbsp;&nbsp; </button><button data-cancel > αιθεμ </button></div> </div></div></div>');
